...
const GOOGLE_API_KEY = "AIzaSyAfgIWcVChkdbGHXhQIL0L7QtFCHpGZn0k";
    ...
    savedConversations.forEach(conversation => {
        ...
        const userMessageHtml = `
            ...
            <div class="message__content">
                <img class="message__avatar"assets/react/chatbot/assets/gemini.svg" alt="User avatar">
        ...
        const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar" src="assets/react/chatbot/assets/gemini.svg" alt="Gemini avatar">
